...
public class ItemInit {
    ...
    public static final Item PRIME_EYE = register("prime_eye", new PrimeEyeItem(new Item.Settings().group(ItemGroup.MISC).maxDamage(16)));
    public static final Item ORC_SKIN = register("orc_skin", new OrcSkinItem(new Item.Settings().group(ItemGroup.MISC)));
    public static final Item DRAGON_SADDLE = register("dragon_saddle", new DragonSaddleItem(new Item.Settings().group(ItemGroup.TRANSPORTATION).maxCount(1)));
