...
public class SoundInit {
    ...
    public static final Identifier FLUTE_CALL = new Identifier("adventurez:flute_call");
    ...
    public static SoundEvent FLUTE_CALL_EVENT = new SoundEvent(FLUTE_CALL);
    // Item Related
    ...
    public static void init() {
        Registry.register(Registry.SOUND_EVENT, GOLEM_IDLE, GOLEM_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, GOLEM_WALK, GOLEM_WALK_EVENT);
        Registry.register(Registry.SOUND_EVENT, GOLEM_HIT, GOLEM_HIT_EVENT);
        Registry.register(Registry.SOUND_EVENT, GOLEM_ROAR, GOLEM_ROAR_EVENT);
        Registry.register(Registry.SOUND_EVENT, GOLEM_DEATH, GOLEM_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, GOLEM_SPAWN, GOLEM_SPAWN_EVENT);
        Registry.register(Registry.SOUND_EVENT, ROCK_IMPACT, ROCK_IMPACT_EVENT);
        Registry.register(Registry.SOUND_EVENT, ROCK_THROW, ROCK_THROW_EVENT);
        Registry.register(Registry.SOUND_EVENT, SMALL_GOLEM_IDLE, SMALL_GOLEM_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, SMALL_GOLEM_WALK, SMALL_GOLEM_WALK_EVENT);
        Registry.register(Registry.SOUND_EVENT, SMALL_GOLEM_HIT, SMALL_GOLEM_HIT_EVENT);
        Registry.register(Registry.SOUND_EVENT, SMALL_GOLEM_DEATH, SMALL_GOLEM_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, HEART_BEAT, HEART_BEAT_EVENT);
        Registry.register(Registry.SOUND_EVENT, PIGLINBEAST_IDLE, PIGLINBEAST_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, PIGLINBEAST_DEATH, PIGLINBEAST_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, PIGLINBEAST_HURT, PIGLINBEAST_HURT_EVENT);
        Registry.register(Registry.SOUND_EVENT, PIGLINBEAST_WALK, PIGLINBEAST_WALK_EVENT);
        Registry.register(Registry.SOUND_EVENT, PIGLINBEAST_SHOUT, PIGLINBEAST_SHOUT_EVENT);
        Registry.register(Registry.SOUND_EVENT, PIGLINBEAST_CLUBSWING, PIGLINBEAST_CLUBSWING_EVENT);
        Registry.register(Registry.SOUND_EVENT, NIGHTMARE_IDLE, NIGHTMARE_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, NIGHTMARE_DEATH, NIGHTMARE_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, NIGHTMARE_HURT, NIGHTMARE_HURT_EVENT);
        Registry.register(Registry.SOUND_EVENT, NIGHTMARE_ANGRY, NIGHTMARE_ANGRY_EVENT);
        Registry.register(Registry.SOUND_EVENT, SOULREAPER_IDLE, SOULREAPER_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, SOULREAPER_HURT, SOULREAPER_HURT_EVENT);
        Registry.register(Registry.SOUND_EVENT, SOULREAPER_DEATH, SOULREAPER_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, SPELL_CAST_SHIELD, SPELL_CAST_SHIELD_EVENT);
        Registry.register(Registry.SOUND_EVENT, MAGIC_SHIELD_HIT, MAGIC_SHIELD_HIT_EVENT);
        Registry.register(Registry.SOUND_EVENT, EYE_DEATH, EYE_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, EYE_HURT, EYE_HURT_EVENT);
        Registry.register(Registry.SOUND_EVENT, EYE_IDLE, EYE_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, EYE_DEATH_PLATFORM, EYE_DEATH_PLATFORM_EVENT);
        Registry.register(Registry.SOUND_EVENT, FUNGUS_IDLE, FUNGUS_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, FUNGUS_HURT, FUNGUS_HURT_EVENT);
        Registry.register(Registry.SOUND_EVENT, FUNGUS_DEATH, FUNGUS_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, ORC_DEATH, ORC_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, ORC_HURT, ORC_HURT_EVENT);
        Registry.register(Registry.SOUND_EVENT, ORC_IDLE, ORC_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, ORC_STEP, ORC_STEP_EVENT);
        Registry.register(Registry.SOUND_EVENT, DRAGON_DEATH, DRAGON_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, DRAGON_HIT, DRAGON_HIT_EVENT);
        Registry.register(Registry.SOUND_EVENT, DRAGON_IDLE, DRAGON_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, DRAGON_STEP, DRAGON_STEP_EVENT);
        Registry.register(Registry.SOUND_EVENT, EQUIP_CHEST, EQUIP_CHEST_EVENT);
        Registry.register(Registry.SOUND_EVENT, MAMMOTH_HIT, MAMMOTH_HIT_EVENT);
        Registry.register(Registry.SOUND_EVENT, MAMMOTH_IDLE, MAMMOTH_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, MAMMOTH_DEATH, MAMMOTH_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, MAMMOTH_BABY_IDLE, MAMMOTH_BABY_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, DRAGON_BREATH, DRAGON_BREATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, CLOSE_SHADOW_CHEST, CLOSE_SHADOW_CHEST_EVENT);
        Registry.register(Registry.SOUND_EVENT, OPEN_SHADOW_CHEST, OPEN_SHADOW_CHEST_EVENT);
        Registry.register(Registry.SOUND_EVENT, IGUANA_DEATH, IGUANA_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, IGUANA_HURT, IGUANA_HURT_EVENT);
        Registry.register(Registry.SOUND_EVENT, IGUANA_IDLE, IGUANA_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, IGUANA_STEP, IGUANA_STEP_EVENT);
        Registry.register(Registry.SOUND_EVENT, WHALE_DEATH, WHALE_DEATH_EVENT);
        Registry.register(Registry.SOUND_EVENT, WHALE_HURT, WHALE_HURT_EVENT);
        Registry.register(Registry.SOUND_EVENT, WHALE_IDLE, WHALE_IDLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, FLUTE_CALL, FLUTE_CALL_EVENT);
    }
}