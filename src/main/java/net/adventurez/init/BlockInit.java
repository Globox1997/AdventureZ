...
public class BlockInit {
    ...
    public static void init() {
        ...
        DRAGON_EGG_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, "adventurez:dragon_egg_entity",
                BlockEntityType.Builder.create(DragonEggEntity::new, Blocks.DRAGON_EGG).build(null));
    }
}