...
public class StoneGolemBlueLavaFeatureRenderer
  ...
  private static final RenderLayer BLUE_LAVA_LAYER = RenderLayer
      .getEntityTranslucentCull(new Identifier("adventurez:textures/entity/blue_lava_feature_golem.png"));
  ...
  public void render(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i,
    ...
    if (stoneGolemEntity.getDataTracker().get(StoneGolemEntity.halfLifeChange)) {
      ...
      this.getContextModel().render(matrixStack, vertexConsumer, 400, OverlayTexture.DEFAULT_UV, 1.0F, 1.0F, 1.0F,
          1.0F);
    }
  }
