...
public class EnderwarthogEyesFeatureRenderer extends FeatureRenderer<EnderwarthogEntity, EnderwarthogModel<EnderwarthogEntity>> {
    private static final RenderLayer EYE_LAYER = ExtraRenderLayer.getGlowing(Identifier.of("adventurez:textures/entity/feature/enderwarthog_eyes_feature.png"));
    private static final RenderLayer RARE_LAYER = RenderLayer.getEntityCutoutNoCull(Identifier.of("adventurez:textures/entity/feature/rare_enderwarthog.png"));
    ...
    public void render(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, EnderwarthogEntity enderwarthogEntity, float f, float g, float h, float j, float k, float l) {
        ...
        if (enderwarthogEntity.getDataTracker().get(EnderwarthogEntity.RARE_VARIANT)) {
            ...
            this.getContextModel().render(matrixStack, otherVertexConsumer, 20, OverlayTexture.DEFAULT_UV);
        }
    }
