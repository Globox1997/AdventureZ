...
public class VoidBulletRenderer extends EntityRenderer<VoidBulletEntity> {
    ...
    private final VoidBulletModel<VoidBulletEntity> model = new VoidBulletModel<>();

    public VoidBulletRenderer(EntityRenderDispatcher dispatcher) {
        super(dispatcher);
    }
    ...
    @Override
    public void render(VoidBulletEntity voidBulletEntity, float f, float g, MatrixStack matrixStack,
            VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        float h = MathHelper.lerpAngle(voidBulletEntity.prevYaw, voidBulletEntity.yaw, g);
        float j = MathHelper.lerp(g, voidBulletEntity.prevPitch, voidBulletEntity.pitch);
